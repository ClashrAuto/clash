...
func TestCoast_Shadowsocks(t *testing.T) {
	for _, method := range []string{
		...
		t.Run(method, func(t *testing.T) {
			testCoast_Shadowsocks(t, method, "FzcLbKs2dY9mhL")
		})
	}
	for _, method := range []string{
		"aes-128-gcm",
		...
		t.Run(method, func(t *testing.T) {
			testCoast_ShadowsocksRust(t, method, "FzcLbKs2dY9mhL")
		})
	}
}

func TestCoast_Shadowsocks2022(t *testing.T) {
	for _, method := range []string{
		"2022-blake3-aes-128-gcm",
	} {
		t.Run(method, func(t *testing.T) {
			testCoast_ShadowsocksRust(t, method, mkKey(16))
		})
	}
	for _, method := range []string{
		...
		t.Run(method, func(t *testing.T) {
			testCoast_ShadowsocksRust(t, method, mkKey(32))
		})
	}
}
...
func testCoast_Shadowsocks(t *testing.T, method string, password string) {
...
func testCoast_ShadowsocksRust(t *testing.T, method string, password string) {
	cfg := &container.Config{
...
func TestCoast_ShadowsocksObfsHTTP(t *testing.T) {
	cfg := &container.Config{
		Image: ImageShadowsocks,
		Env: []string{
			"SS_MODULE=ss-server",
...
func TestCoast_ShadowsocksObfsTLS(t *testing.T) {
	cfg := &container.Config{
		Image: ImageShadowsocks,
		Env: []string{
			"SS_MODULE=ss-server",
...
func TestCoast_ShadowsocksV2RayPlugin(t *testing.T) {
	cfg := &container.Config{
		Image: ImageShadowsocks,
		Env: []string{
			"SS_MODULE=ss-server",
...
func TestCoast_ShadowsocksUoT(t *testing.T) {
