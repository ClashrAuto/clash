...
type Domain struct {
	...
	Type Domain_Type `protobuf:"varint,1,opt,name=type,proto3,enum=clashauto.component.geodata.router.Domain_Type" json:"type,omitempty"`
	// Domain value.
...
var file_component_geodata_router_config_proto_goTypes = []interface{}{
	(Domain_Type)(0),         // 0: clashauto.component.geodata.router.Domain.Type
	(*Domain)(nil),           // 1: clashauto.component.geodata.router.Domain
	(*CIDR)(nil),             // 2: clashauto.component.geodata.router.CIDR
	(*GeoIP)(nil),            // 3: clashauto.component.geodata.router.GeoIP
	(*GeoIPList)(nil),        // 4: clashauto.component.geodata.router.GeoIPList
	(*GeoSite)(nil),          // 5: clashauto.component.geodata.router.GeoSite
	(*GeoSiteList)(nil),      // 6: clashauto.component.geodata.router.GeoSiteList
	(*Domain_Attribute)(nil), // 7: clashauto.component.geodata.router.Domain.Attribute
}
var file_component_geodata_router_config_proto_depIdxs = []int32{
	0, // 0: clashauto.component.geodata.router.Domain.type:type_name -> clashauto.component.geodata.router.Domain.Type
	7, // 1: clashauto.component.geodata.router.Domain.attribute:type_name -> clashauto.component.geodata.router.Domain.Attribute
	2, // 2: clashauto.component.geodata.router.GeoIP.cidr:type_name -> clashauto.component.geodata.router.CIDR
	3, // 3: clashauto.component.geodata.router.GeoIPList.entry:type_name -> clashauto.component.geodata.router.GeoIP
	1, // 4: clashauto.component.geodata.router.GeoSite.domain:type_name -> clashauto.component.geodata.router.Domain
	5, // 5: clashauto.component.geodata.router.GeoSiteList.entry:type_name -> clashauto.component.geodata.router.GeoSite
