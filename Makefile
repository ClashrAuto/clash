...
GOBUILD=CGO_ENABLED=0 go build -tags with_gvisor -trimpath -ldflags '-X "github.com/ClashrAuto/coast/constant.Version=$(VERSION)" \
		-X "github.com/ClashrAuto/coast/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
